# Create container
```
docker run -it -d --name=syneco -h=syneco -p 1080:80 -p 1022:22 -p 9001:9000 eagle88/syneco /bin/bash
```
# MariaDB
```
user: root 
...
```
# Origin
[Docker Hub] (https://registry.hub.docker.com/u/eagle88/syneco/)
[Git Hub] (https://github.com/WhiteEagle88/docker-syneco)
